    ...
    >
      ...
      <div className="sm:ml-4 md:ml-14 sm:w-[90rem]  w-full ">
        ...
        <h2 className="text-center text-[12px] px-6 sm:p-0  sm:text-left sm:text-[14px] sm:pr-8 md:text-[12px] lg:text-[19px]  xl:text-[22px] font-bold text-blue-ac1 dark:text-muted mt-3 md:mt-0">
          Software engineer with a passion for learning and a strong foundation
          in Full Stack development, backed by real-world experience in
          innovative projects. I am committed to continuous growth, both in
          knowledge and expertise, and strive to apply my related skills and
          strengths to achieve future career goals. With excellent interpersonal
          and communication skills, I am seeking a position that challenges me
          and offers opportunities for both personal and professional
          development.
        </h2>
        <button
          onClick={() => downloadCV()}
